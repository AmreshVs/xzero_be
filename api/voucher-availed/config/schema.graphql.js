    ...
    Mutation: {
      BuyVoucher: {
        ...
        resolver: async (obj, options, ctx) => {
          return await strapi.api["voucher-availed"].controllers[
            "voucher-availed"
          ].BuyVoucher(options.user_id, options.voucher_id, options.code);
        },
      },
