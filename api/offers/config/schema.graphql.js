  ...
  resolver: {
    Query: {
      offerListWithFavourites: {
        ...
        resolver: async (obj, options, ctx) => {
          return await strapi.api.offers.controllers.offers.offerListWithFavourites(
            options.where || {},
            options.user_id
          );
        },
      ...
      offerIsFavourite: {
        ...
        resolverOf: "application::offers.offers.find",
        resolver: async (obj, options, ctx) => {
          return await strapi.api.offers.controllers.offers.offerIsFavourite(
            options.offer_id,
            options.user_id
          );
        },
      ...
      favouritesByUser: {
        ...
        resolverOf: "application::offers.offers.find",
        resolver: async (obj, options, ctx) => {
          return await strapi.api.offers.controllers.offers.favouritesByUser(
            options.user_id
          );
        },
      },
    ...
    Mutation: {
      addFavourite: {
        ...
        resolver: async (obj, options, ctx) => {
          return await strapi.api.offers.controllers.offers.addFavourite(
            options.user_id,
            options.offer_id
          );
        },
